    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {showCreateResume && (
          ...
          >
            <div
              className="relative bg-white w-[90%] max-w-md rounded-lg p-6 shadow-xl"
              onClick={(e) => e.stopPropagation()}
            >
        ...
        {/* UPLOAD RESUME MODAL (THIS FIXES YOUR ISSUE) */}
        {showUploadResume && (
          <form
          ...
          >
            ...
            >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="flex item-center justify-center gap-2 w-full py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors flex item-center justify-center gap-2">
